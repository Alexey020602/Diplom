...
public class Interaction
{
    ...
    [JsonIgnore] public List<Direction> Directions { get; set; } = null!;
    public override string ToString() => $"{ContactCode} ���� {InteractionType} �� {SigningDateTime}, {BeginigDateTime} - {EndingDateTime}";
}